...
class AdidasUi extends StatefulWidget {
  @override
  _AdidasUiState createState() => new _AdidasUiState();
}
        ...
        child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text("Energy Cloud",
                  style: TextStyle(
                      color: Colors.white, fontSize: screenAwareSize(18.0, context), fontFamily: "Montserrat-Bold")),
              centerTitle: true,
              actions: <Widget>[
                IconButton(
                  icon: Icon(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: AnimatedCrossFade(
              firstChild: Text(
                ...
                maxLines: 2,
                style: TextStyle(
                    color: Colors.white, fontSize: screenAwareSize(10.0, context), fontFamily: "Montserrat-Medium"),
              ),
              secondChild: Text(
                desc,
                style: TextStyle(
          ...
          Padding(
            ...
            child: GestureDetector(
                ...
                child: Text(
                  ...
                  style: TextStyle(color: Color(0xFFFB382F), fontWeight: FontWeight.w700),
                )),
          ),
          SizedBox(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(color: Color(0xFF525663), borderRadius: BorderRadius.circular(5.0)),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: <Widget>[
                        Flexible(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text("-",
                                    style:
                                    TextStyle(color: Colors.white, fontSize: 20.0, fontFamily: "Montserrat-Bold")),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(_counter.toString(),
                                  style: TextStyle(color: Colors.white, fontSize: 20.0, fontFamily: "Montserrat-Bold")),
                            ),
                          ),
                        ),
                        divider(),
          ...
          Padding(
            ...
            child: Text("Price", style: TextStyle(color: Color(0xFF949598), fontFamily: "Montserrat-SemiBold")),
          ),
          Container(
            width: double.infinity,
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: Text("Add To Cart",
                                  ...
                                  style: TextStyle(color: Colors.white, fontSize: screenAwareSize(15.0, context))),
                            ),
                          ),
                        ),
                      )
...
Widget sizeItem(String size, bool isSelected, BuildContext context) {
  return Padding(
    ...
    child: Container(
      ...
      child: Center(
        child: Text(size, style: TextStyle(color: Colors.white, fontFamily: "Montserrat-Bold")),
      ),
    ),
  );
}
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: isSelected
                ? [BoxShadow(color: Colors.black.withOpacity(.8), blurRadius: 10.0, offset: Offset(0.0, 10.0))]
                : []),
        child: ClipPath(
          clipper: MClipper(),
          child: Container(
