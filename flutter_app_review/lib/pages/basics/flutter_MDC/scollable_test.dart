...
class ScrollableHome extends StatefulWidget {
  @override
  _ScrollableHomeState createState() => new _ScrollableHomeState();
}
...
//    ],);
  ...
  return new GridView.builder(
    gridDelegate: new SliverGridDelegateWithMaxCrossAxisExtent(maxCrossAxisExtent: 100, childAspectRatio: 1),
    itemBuilder: (context, index) {
