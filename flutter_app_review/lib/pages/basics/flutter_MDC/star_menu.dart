...
class StarMenuDemo extends StatefulWidget {
  @override
  StarMenuDemoState createState() => StarMenuDemoState();
}

class StarMenuDemoState extends State<StarMenuDemo> {
  GlobalKey iconKey;
  GlobalKey fabKey1;
  GlobalKey fabKey2;
  GlobalKey fabKey3;
  ...
  Widget _buildSubMenu(GlobalKey parent) {
    return StarMenu(
      ...
      radiusY: 80,
      startAngle: 0,
      endAngle: 180.0 / 3.0 * 4.0,
      // to let the last item to be exactly at 180 degree: [angle / (items-1) * items]
      durationMs: 600,
      itemDelayMs: 200,
      ...
      items: <Widget>[
        Container(
          decoration: ShapeDecoration(
              color: Colors.purple, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15.0))),
          width: 40,
          height: 40,
        ),
        Container(
          decoration: ShapeDecoration(
              color: Colors.blue, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15.0))),
          width: 40,
          height: 40,
        ),
        Container(
          decoration: ShapeDecoration(
              color: Colors.green, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15.0))),
          width: 40,
          height: 40,
        ),
        Container(
          decoration: ShapeDecoration(
              color: Colors.limeAccent, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15.0))),
          width: 40,
          height: 40,
        ),
      ],
  ...
  Widget _buildMenu(GlobalKey parent, MenuShape shape, double startAngle) {
    return StarMenu(
      ...
      items: <Widget>[
        Container(
          child: Image.asset(
            'assets/images/emoticon_017.png',
            width: 50,
            height: 50,
          ),
        ),
        ...
        Container(
          child: Image.asset(
            'assets/images/emoticon_008.png',
            width: 50,
            height: 50,
          ),
        ),
        ...
        Container(
          child: Image.asset(
            'assets/images/emoticon_050.png',
            width: 50,
            height: 50,
          ),
        ),
        Container(
          child: Image.asset(
            'assets/images/emoticon_114.png',
            width: 80,
            height: 80,
          ),
        ),
        Container(
          child: Image.asset(
            'assets/images/emoticon_100.png',
            width: 50,
            height: 50,
          ),
        ),
