...
class DialogUtil {
  ...
  Future<T> showMyDialog<T>(BuildContext context,
      {Widget title, Widget content, VoidCallback onConfim, VoidCallback onCancle}) {
    return showDialog<T>(
        context: context,
        builder: (context) {
  ...
  Future<T> showMyDialogWithColumn<T>(BuildContext context,
      {Widget title, Column column, VoidCallback onConfim, VoidCallback onCancel}) {
    return showDialog<T>(
        context: context,
        builder: (context) {
          return new AlertDialog(
  ...
  Future<T> showMyDialogWithListView<T>(BuildContext context,
      {ListView listview, Widget title, double width, double height, VoidCallback onConfirm, VoidCallback onCancel}) {
    return showDialog<T>(
      context: context,
